...
- `paper-performance-results.csv`: A copy of our output from `reproduce-performance.sh` used to describe performance in Section 7 of the paper.

**NOTE:** `sec-11/sandpile-original.fuse` and `sec-11/sandpile-optimized.fuse` were adapted from `abelian-sandpile/sandpile.fuse.m4` from the [`dahlia-cookbook` repository](https://github.com/Mark1626/dahlia-cookbook) by [Nimalan](https://github.com/Mark1626). The license for the Dahlia cookbook can be found under `sec-11/LICENSE-dahlia-cookbook`.
